local M={}
M.ns=vim.api.nvim_create_namespace'small_statusbuf'
...
--vim.api.nvim_buf_set_lines(buf,0,-1,false,{vim.api.nvim_eval_statusline(statusline,{maxwidth=maxwidth}).str})
--local col=0
...
function M.run()
    ...
    vim.api.nvim_set_decoration_provider(M.ns,{on_start=function ()
        M.clear()
    end})
